...
for i= 1:numel(R)
    hold on;
    scatter(R(i), coding_Gain(i),100, colors(i,:), "filled", "o", 'DisplayName',rate_legend(i))
end
...
for i= 1:numel(R)
    hold on;
    scatter(R(i), NCG(i),100, colors(i,:), "filled", "o", 'DisplayName',rate_legend(i))
end
...
for i= 1:numel(R)
    hold on;
    scatter(R(i), (coding_Gain(i)/fiber_att),100, colors(i,:), "filled", "o")
end
